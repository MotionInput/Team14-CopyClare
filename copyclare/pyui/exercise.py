...
class Ui_exercise_frame(object):
    def setupUi(self, exercise_frame):
        ...
        self.reps_label = QLabel(self.data_frame)
        self.reps_label.setObjectName(u"reps_label")
        font = QFont()
        font.setPointSize(27)
        font.setBold(True)
        self.reps_label.setFont(font)
        self.reps_label.setStyleSheet(u"color: #000000;\n"
"padding: 10px;")
        self.reps_label.setFrameShape(QFrame.NoFrame)

        self.verticalLayout_2.addWidget(self.reps_label)
...
"}")
    ...
    def retranslateUi(self, exercise_frame):
        ...
        self.reps_label.setText(QCoreApplication.translate("exercise_frame", u"Reps: 0", None))
