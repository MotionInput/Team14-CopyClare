...
"}")
        ...
        icon2 = QIcon()
        icon2.addFile(u"../../data/settings.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.addvideo_button = QPushButton(self.frame)
        self.addvideo_button.setObjectName(u"addvideo_button")
        self.addvideo_button.setFlat(True)

        self.verticalLayout_2.addWidget(self.addvideo_button)
        ...
        self.exercise_frame = QFrame(self.main_frame)
        self.exercise_frame.setObjectName(u"exercise_frame")
        self.exercise_frame.setFrameShape(QFrame.NoFrame)
        self.exercise_frame.setFrameShadow(QFrame.Plain)
        self.exercise_frame.setLineWidth(0)
        self.exercise_layout = QHBoxLayout(self.exercise_frame)
        self.exercise_layout.setSpacing(0)
