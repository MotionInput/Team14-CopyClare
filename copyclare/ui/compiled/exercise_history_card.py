...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = QIcon()
        icon.addFile(
            u"../../../../../Documents/\ud83d\udcda/--UCL/-STUDY STUFF/YEAR 2/COMP0016 Systems Engineering/copyclare/prototype/pages/icon-analysis.png",
        ...
        icon1 = QIcon()
        icon1.addFile(
            u"../../../../../Documents/\ud83d\udcda/--UCL/-STUDY STUFF/YEAR 2/COMP0016 Systems Engineering/copyclare/prototype/pages/icon-export.png",
            QSize(), QIcon.Normal, QIcon.Off)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(
            QCoreApplication.translate("Form", u"Shoulder Exercise", None))
