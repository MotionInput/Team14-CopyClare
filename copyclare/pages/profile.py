...
class ProfilePage(Page):
    def __init__(self, master):
        ...
        ex1_attempt = [Attempt(None,"1-1-1",1,1.11,"111",11,"a",1), Attempt(None,"2-2-2",2,2.22,"222",22,"a",1), Attempt(None,"3-3-3",3,3.33,"333",33,"a",1), Attempt(None,"4-4-4",4,4.44,"444",44,"a",1), Attempt(None,"5-5-5",5,5.55,"555",55,"a",1)]
        ex2_attempt = [Attempt(None,"1-1-1",1,1.11,"111",44,"b",2), Attempt(None,"2-2-2",2,2.22,"222",33,"b",2), Attempt(None,"3-3-3",3,3.33,"333",22,"b",2), Attempt(None,"4-4-4",4,4.44,"444",11,"b",2)]
        ex3_attempt = [Attempt(None,"1-1-1",1,1.11,"111",33,"c",3), Attempt(None,"2-2-2",2,2.22,"222",22,"c",3), Attempt(None,"3-3-3",3,3.33,"333",11,"c",3), Attempt(None,"4-4-4",4,4.44,"444",44,"c",3), Attempt(None,"5-5-5",5,5.55,"555",55,"c",3)]
        ex4_attempt = [Attempt(None,"1-1-1",1,1.11,"111",22,"d",4), Attempt(None,"2-2-2",2,2.22,"222",22,"d",4)]
